...
class MainActivity : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        Log.d("test Avg less than median", averageLessThanMedian(testArray as List<Double>).toString())
    ...
    //class GetTestArray (private val getTestDataArray: List<Int>, val testArray: MutableList<Int>){
    //    return testArray.sort(Random.nextInt)
    //}
    ...
    //class averageLessThanMedian(val sortedList: List<Double>, val avg: List<Int>, val median:
    //    (Unit -> Boolean) {
    //   true if (sortedList.size % 2 == 0) +), false if([sortedList.size / 2] + sortedList[sortedList.size
    //    - 1] / 2
    //}
